...
const API_KEY = "CG-fE2xUGccdiFXM9THzncMJfDH";
const getCoinList = (page, currency) => {
  return `${BASE_URL}/coins/markets?vs_currency=${currency}&order=market_cap_desc&per_page=5&page=${page}&&x_cg_demo_api_key=${API_KEY}`;
};
